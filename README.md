...
#### 1. 메인 메뉴
#### 2. 게임 씬 이동
#### 3. 맵의 각 구역에 랜덤한 건물들 배치, 시민 배치 , 경찰 배치
#### 4. 정치인의 정책리스트 초기화 (싱글톤)
#### 5. 플레이어 미션 초기화 (싱글톤),(스크립터블 오브젝트)
#### 6. 도시의 각종 정보 초기화 (싱글톤)
#### 7. 실제 게임 씬 동작 시작 
### ★왜 이 프로젝트를 기획했나? ★
...
#### 지인들을 통해서 매번 부탁하는 것도
#### 생각보다 어려운 일이였다.
#### 또한, 파티클 시스템 보다는 VFX를 더 사용하려 했으며,
#### 게임의 완성도를 위해 VFX에 생각보다 비중있는 시간을 들였다.
-----------
### ★ 앞으로 이 프로젝트는 ? ★

#### 게임의 컨텐츠를 추가하여 완성도를 높이기
#### 스팀에 출시.
#### 오큘루전 컬링을 통한 최적화 진행
#### 포스트프로세싱 추가
#### 낮과 밤 환경 추가
